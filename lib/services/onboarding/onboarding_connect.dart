...
class OnBoardingConnect extends GetConnect {
  final InitController _initC;
  late final Map<String, String> headers;

  OnBoardingConnect(this._initC) {
  ...
  Future<Response> saveAssistPref(Map<String, dynamic> body) => post(
        'Masyarakats/addAssistPref',
        body,
        // headers: headers,
      );
