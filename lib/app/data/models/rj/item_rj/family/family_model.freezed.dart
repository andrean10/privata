...
class _$FamilyModelImpl implements _FamilyModel {
  ...
  @override
  String toString() {
    return 'FamilyModel(name: $name, relation: $relation, gender: $gender, phoneNumber: $phoneNumber, bloodType: $bloodType, occupation: $occupation, address: $address, createdAt: $createdAt, updatedAt: $updatedAt, createdId: $createdId, updatedId: $updatedId, id: $id, email: $email, dateOfBirth: $dateOfBirth)';
  }
